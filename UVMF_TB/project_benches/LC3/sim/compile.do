...
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/write_back_in_pkg/compile.do
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/write_back_out_pkg/compile.do
...
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/instruction_memory_pkg/compile.do
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/data_memory_pkg/compile.do
