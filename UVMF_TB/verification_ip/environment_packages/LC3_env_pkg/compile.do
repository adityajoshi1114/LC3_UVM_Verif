...
eval $cmd
# Include build for sub-environment write_back_env_pkg
quietly set cmd [format "source %s/environment_packages/write_back_env_pkg/compile.do" $env(UVMF_VIP_LIBRARY_HOME)]
eval $cmd
